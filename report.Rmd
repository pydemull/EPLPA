...
```{r show_final_fig_by_sex, fig.height = 16, fig.width = 13, out.width = '100%'}
p_pl_by_sex
```
...
```{r show_pa_metrics_by_sex, fig.height = 15, fig.width = 18, out.width = '100%'}
p_pa_metrics_by_sex
```
...
df_corr_pa <-
  ...
  rename(
      ...
      "Daily MX 15 min" = "M15",
      "Daily MX 5" = "M5",
      "Daily Number of SED breaks" = "mean_breaks",
      "Power low exponent alpha" = "alpha",
      "Median SED bout duration (min)" = "MBD",
      "Usual SED bout duration (min)" = "UBD",
      "Gini index for SED" = "gini",
